...
def python_benchmark(num_runs=3):
    ...
    cv2.imwrite("img/rain_grayscale_python.jpeg", python_color2gray.color2gray(image))
    return
...
def numpy_benchmark(num_runs=3):
    ...
    with open("reports/numpy_report_color2gray.txt", "w") as file:
        ...
        # Fetch runtime of pure python implementation by parsing the report
        python_runtime = get_runtime_from_report("reports/python_report_color2gray.txt")
    ...
    # Save a copy of the image as a quick "unit test"
    cv2.imwrite("img/rain_grayscale_numpy.jpeg", numpy_color2gray.color2gray(image))
...
def numba_benchmark(num_runs=3):
    ...
    with open("reports/numba_report_color2gray.txt", "w") as file:
        ...
        numpy_runtime = get_runtime_from_report("reports/numpy_report_color2gray.txt")
        file.write("Average runtime running of numba_color2gray is ")
...
"""
    ...
    # Save a copy of the image as a quick "unit test"
    cv2.imwrite("img/rain_grayscale_numba.jpeg", numba_color2gray.color2gray(image))
    return
...
def cython_benchmark(num_runs=3):
    ...
    with open("reports/cython_report_color2gray.txt", "w") as file:
        ...
        numba_runtime = get_runtime_from_report("reports/numba_report_color2gray.txt")
        file.write("Average runtime running of cython_color2gray is ")
